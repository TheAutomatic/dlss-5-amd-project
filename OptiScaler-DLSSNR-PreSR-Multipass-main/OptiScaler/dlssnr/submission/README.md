...
- Min G1 admission reject (`MarkSplitIneligible`): open split barrier / aliasing / `resource_state`; query / predication / enhanced_barrier / render_pass. Split then fails → ordinary SR (safe reject).
