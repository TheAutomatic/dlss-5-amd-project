...
.SYNOPSIS
  ...
  Default product: OptiScaler-AMD-PreSR-1.9.0
    ...
    0.3.3  = supported danielblnc runtime (0.3.2 / 0.3.1 / 0.3.0 also accepted)
...
; daniel - danielblnc 0.3.0 / 0.3.1 / 0.3.2 / 0.3.3 runtime (using dlssnr_amd_pass*.dll + weights.bin)
